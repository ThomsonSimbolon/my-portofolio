...
const App = () => {
  ...
  useEffect(() => {
    if (window.innerWidth >= 1024) {
      // Aktifkan AOS hanya untuk layar desktop (>= 1024px)
      AOS.init({
        duration: 2500,
        disable: false, // Jangan nonaktifkan AOS pada desktop
      });
    } else {
      AOS.init({
        disable: true, // Nonaktifkan AOS pada perangkat non-desktop
      });
    }
    AOS.refresh();
  ...
  return (
    <div className="dark:bg-gray-950">
      ...
      <header className="md:backdrop-blur md:border-0 border-b border-gray-200 dark:border-gray-800 sticky top-0 z-50 bg-gray-50 dark:bg-gray-950">
        <div className="mx-auto px-4 sm:px-6 lg:px-24 max-w-full flex items-center justify-between gap-3 h-[--header-height]">
          <div className="flex items-center gap-1.5">
            <a
              href="#home"
              className="cursor-pointer router-link-active router-link-exact-active flex-shrink-0 font-bold text-2xl text-gray-900 dark:text-white flex items-end gap-1.5"
            >
              Thomson
              <span className="txt-greens inline-flex items-center font-medium rounded-md text-xs px-2 py-1 bg-primary-50 dark:bg-primary-400 dark:bg-opacity-10 text-primary-500 dark:text-primary-400 ring-1 ring-inset ring-primary-500 dark:ring-primary-400 ring-opacity-25 dark:ring-opacity-25 mb-0.5">
                Portfolio
              </span>
            </a>
          </div>
          ...
          {/* Navbar */}
          <ul className="items-center ring-1 ring-gray-200 dark:ring-gray-800 px-3 gap-x-0 rounded-full hidden lg:flex">
            {navLinks.map((link) => (
              <li key={link.id}>
                <Link
                  to={link.id}
                  ...
                  duration={500}
                  spy={true}
                  activeClass="text-sm/6 cursor-pointer flex items-center gap-1 py-2 px-4 font-medium relative after:absolute after:-bottom-px after:inset-x-2 after:h-px after:rounded-full transition-colors text-gray-400 after:bg-gray-900 dark:after:bg-white after:transition-opacity dark:text-white after:opacity-100"
                  className="text-sm/6 cursor-pointer flex items-center gap-1 py-2 px-4 font-medium relative hover:after:absolute hover:after:-bottom-px hover:after:inset-x-2 after:h-px after:rounded-full transition-colors dark:hover:text-gray-200 after:bg-gray-900 dark:after:bg-white after:transition-opacity text-gray-900 dark:text-gray-400 after:opacity-100"
                >
                  {link.title}
                </Link>
              </li>
          ...
          <div className="flex items-center justify-end gap-1.5">
            <a
              href="#contact"
              className="hidden txt-greens lg:flex focus:outline-none font-medium rounded-full text-sm gap-x px-3 py-2 text-gray-900 dark:text-white hover:bg-white dark:hover:bg-gray-900 focus-visible:ring-2 focus-visible:ring-primary-500 dark:focus-visible:ring-primary-400 bg-primary-50 dark:bg-primary-400 dark:bg-opacity-10 text-primary-500 dark:text-primary-400 ring-1 ring-inset ring-primary-500 hover:ring-0 dark:ring-primary-400 ring-opacity-25 dark:ring-opacity-25"
            >
              Contact Us
              <span>
                <BiRightArrowAlt
        ...
        {/* Mobile Menu */}
        {isMobileMenuOpen && (
          <div className="lg:hidden bg-gray-50 dark:bg-gray-950 top-0">
            <ul className="flex flex-col items-center py-4">
              {navLinks.map((link) => (
                <li className="w-full text-start" key={link.id}>
                  <a
                    href={link.path}
                    className="block py-2 px-4 transition-colors hover:text-gray-400 text-gray-900 dark:text-white"
                    onClick={toggleMobileMenu}
                  >
                    {link.title}
                  </a>
            ...
            <div className="flex justify-center items-center border-t border-gray-200 dark:border-gray-800 p-4 bg-gray-50 dark:bg-gray-950">
              <a
                href="#about"
                className="flex justify-center items-center text-center font-medium rounded-full w-56 md:w-full text-sm gap-x-1 md:p-3 p-2 bg-slate-900 text-white hover:bg-white dark:hover:bg-gray-900 focus-visible:ring-2 focus-visible:ring-primary-500 dark:focus-visible:ring-primary-400"
              >
                Get Started
                <span>
                  <BiRightArrowAlt
      ...
      <main className="min-h-[calc(100vh-var(--header-height))]">
        <div>
          ...
          <div className="py-12 sm:py-24 md:py-30 relative" id="home">
            <div className="mx-auto px-4 lg:px-24 sm:px-6 max-w-full flex flex-col md:flex-row gap-16 sm:gap-y-24">
              {/* Text Column */}
              <div className="flex-1 flex md:w-1/2 flex-col">
                ...
                <div className="flex flex-col md:flex-row gap-2">
                  <a
                    href={MyCV}
                    target="_blank"
                    className="brd-greens txt-greens shadow-sm shadow-slate-100 flex items-center gap-1 justify-center hover:text-white px-8 py-2 hover:dark:bg-slate-900 hover:border-1 hover:border-slate-900 rounded-full"
                  >
                  ...
                  <a
                    ...
                    target="_blank"
                    className="focus:outline-none shadow-sm shadow-slate-100 flex items-center gap-2 justify-center px-8 py-2 text-gray-700 dark:text-gray-200 bg-gray-50 hover:bg-gray-100 dark:bg-gray-800 dark:hover:bg-gray-700 rounded-full"
                  >
                    <FaGithub />
                    GitHub
                  </a>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 mt-5">
                  ...
                  <div className="flex items-center gap-4">
                    <a
                      ...
                      target="_blank"
                      className="flex txt-greens ring-1 ring-gray-200 dark:ring-gray-800 shadow-sm shadow-white rounded-full dark:hover:bg-neutral-800 hover:ring-0 p-2 items-center gap-1 text-white hover:text-blue-600"
                    >
                      <FaLinkedin />
                    </a>
                    <a
                      ...
                      target="_blank"
                      className="flex txt-greens ring-1 ring-gray-200 dark:ring-gray-800 shadow-sm shadow-white rounded-full dark:hover:bg-neutral-800 hover:ring-0 p-2 items-center gap-1 text-white hover:text-gray-400"
                    >
                      <FaFacebook />
                    </a>
                    <a
          ...
          <div className="py-12 sm:py-20" id="about">
            <div className="mx-auto px-4 sm:px-4 lg:px-0 max-w-7xl gap-16 sm:gap-y-24 flex flex-col">
              <div className="flex flex-col items-center">
                <h2 className="text-center text-3xl font-bold tracking-tight sm:text-4xl lg:text-5xl relative after:absolute after:-bottom-px after:inset-x-2 after:h-px after:rounded-full transition-colors hover:text-gray-400 after:bg-gray-900 dark:after:bg-gray-400 after:transition-opacity text-gray-900 dark:text-white after:opacity-100">
                  About
                </h2>
              </div>
              <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-2 gap-6 scroll-mt-[calc(var(--header-height)+140px+128px+96px)]">
                ...
                <div
                  data-aos="fade-right"
                  className="relative group isolate rounded-xl background-gradient ring-1 ring-gray-200 dark:ring-gray-800 before:hidden before:lg:block before:absolute before:-inset-[2px] before:h-[calc(100%+4px)] before:w-[calc(100%+4px)] before:z-[-1] before:rounded-[13px] flex-1 flex flex-col shadow shadow-indigo-700"
                >
                  <div className="flex-1 flex flex-col overflow-hidden rounded-xl divide-y divide-gray-200 dark:divide-gray-800 bg-white dark:bg-gray-900 hover:bg-opacity-90 dark:hover:bg-opacity-90 transition-[background-opacity]">
                ...
                >
                  <div className="flex-1 flex flex-col overflow-hidden rounded-xl divide-y divide-gray-200 dark:divide-gray-800 bg-white dark:bg-gray-900 hover:bg-opacity-90 dark:hover:bg-opacity-90 transition-[background-opacity]">
                    {/* Image Container */}
                    <div className="relative w-full h-80 sm:h-80 lg:h-96 overflow-hidden rounded-xl">
                      <img
                        src={Hero2} // Replace with your image URL
                        alt="About Image"
                        className="w-full h-full object-cover"
                      />
                    </div>
                    {/* <div className="gap-x-8 gap-y-4 rounded-xl flex-1 flex flex-col px-4 py-5 sm:p-6">
                      <h3 className="text-lg font-medium sm:text-xl lg:text-2xl text-gray-800 dark:text-gray-300">
                        Explore More
                      </h3>
                      <p className="text-gray-600 dark:text-gray-400">
                        This is an example of a responsive image card that
                        adjusts its size and layout based on screen resolution.
                      </p>
                    </div> */}
                  </div>
                </div>
          ...
          <div className="py-12 sm:py-20" id="skills">
            <div className="mx-auto px-4 sm:px-4 lg:px-0 max-w-7xl gap-16 sm:gap-y-24 flex flex-col">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-8 scroll-mt-[calc(var(--header-height)+140px+128px+96px)]">
                ...
                <div
                  data-aos="flip-left"
                  className="relative group isolate rounded-xl background-gradient ring-1 ring-gray-200 dark:ring-gray-800 before:hidden before:lg:block before:absolute before:-inset-[2px] before:h-[calc(100%+4px)] before:w-[calc(100%+4px)] before:z-[-1] before:rounded-[13px] flex-1 flex flex-col shadow shadow-white"
                >
                  <div className="flex-1 flex flex-col cursor-pointer overflow-hidden rounded-xl divide-y divide-gray-200 dark:divide-gray-800 bg-white dark:bg-gray-900 hover:bg-opacity-90 dark:hover:bg-opacity-90 transition-[background-opacity]">
                    <div className="gap-x-8 gap-y-4 rounded-xl flex-1 flex flex-col px-4 py-5 sm:p-6">
          ...
          <div className="py-12 sm:py-20" id="education">
            <div className="mx-auto px-4 sm:px-4 lg:px-0 max-w-7xl gap-16 sm:gap-y-24 flex flex-col">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-8 scroll-mt-[calc(var(--header-height)+140px+128px+96px)]">
                    ...
                    <div className="gap-x-8 gap-y-4 rounded-xl flex-1 flex flex-col px-4 py-5 sm:p-6">
                      <div className="mb-2 pointer-events-none">
                        ...
                        <div className="flex items-center gap-2 mt-2">
                          <GiDuration className="w-5 h-5 text-gray-500 dark:text-gray-200" />
                          <span className="text-gray-600 dark:text-gray-200">
                            Duration: 2020 ~ 2024
                          </span>
                        </div>
                        <div className="flex items-center gap-2 mt-2">
                          <MdIncompleteCircle className="w-5 h-5 text-gray-500 dark:text-gray-200" />
                          <span className="text-gray-600 dark:text-gray-200">
                            Finished
                          </span>
                        </div>
                ...
                <div
                  data-aos="fade-up"
                  className="relative group isolate rounded-xl background-gradient ring-1 ring-gray-200 dark:ring-gray-800 before:hidden before:lg:block before:absolute before:-inset-[2px] before:h-[calc(100%+4px)] before:w-[calc(100%+4px)] before:z-[-1] before:rounded
                ...
                >
                  <div className="flex-1 flex flex-col cursor-pointer overflow-hidden rounded-xl divide-y divide-gray-200 dark:divide-gray-800 bg-white dark:bg-gray-900 hover:bg-opacity-90 dark:hover:bg-opacity-90 transition-[background-opacity]">
                    <div className="relative">
                      ...
                      />
                      <div className="absolute inset-0 opacity-50 bg-black dark:bg-white transition-opacity" />
                    </div>
                    <div className="gap-x-8 gap-y-4 rounded-xl flex-1 flex flex-col px-4 py-5 sm:p-6">
                      <div className="mb-2 pointer-events-none">
                        <h3 className="text-gray-900 dark:text-white text-base font-bold">
                        ...
                        <p className="text-[15px] text-gray-500 dark:text-gray-400 mt-1">
                          ...
                          and React Bootstrap.
                          <span className="text-gray-600 ml-2 dark:text-gray-200">
                            (Github)
                          </span>
                        </p>
                      </div>
          ...
          <div className="py-12 sm:py-20" id="experience">
            <div className="mx-auto px-4 sm:px-4 lg:px-0 max-w-7xl gap-16 sm:gap-y-24 flex flex-col">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-2 gap-6 scroll-mt-[calc(var(--header-height)+140px+128px+96px)]">
                ...
                <div
                  data-aos="fade-right"
                  className="relative group isolate rounded-xl background-gradient ring-1 ring-gray-200 dark:ring-gray-800 before:hidden before:lg:block before:absolute before:-inset-[2px] before:h-[calc(100%+4px)] before:w-[calc(100%+4px)] before:z-[-1] before:rounded-[13px] flex flex-col items-center justify-center shadow shadow-indigo-700"
                >
                  <div className="flex flex-col overflow-hidden rounded-xl divide-y divide-gray-200 dark:divide-gray-800 hover:bg-opacity-90 dark:hover:bg-opacity-90 transition-[background-opacity]">
                    {/* Image Container */}
          ...
          <div className="py-12 sm:py-20" id="contact">
            <div className="mx-auto px-4 sm:px-4 lg:px-0 max-w-7xl gap-16 sm:gap-y-24 flex flex-col">
              ...
              <div className="scroll-mt-[calc(var(--header-height)+140px+128px+96px)]">
                ...
                <div
                  data-aos="fade-up"
                  className="relative group isolate rounded-xl background-gradient ring-1 ring-gray-200 dark:ring-gray-800 before:hidden before:lg:block before:absolute before:-inset-[2px] before:h-[calc(100%+4px)] before:w-[calc(100%+4px)] before:z-[-1] before:rounded-[13px] flex-1 flex items-center justify-center shadow shadow-indigo-700"
                >
                  <div className="w-full grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-2 overflow-hidden rounded-xl divide-y divide-gray-200 dark:divide-gray-800 bg-white dark:bg-gray-900 hover:bg-opacity-90 dark:hover:bg-opacity-90 transition-[background-opacity]">
                    ...
                    <div className="gap-x-8gap-y-4 justify-center rounded-xl flex-1 flex flex-col px-4 py-5 sm:p-6">
                      ...
                      <div className="mt-5">
                        ...
                        <form
                          ref={form}
                          className="max-w-2xl mx-auto p-6 bg-gray-100 dark:bg-gray-800 rounded-lg shadow-lg"
                          onSubmit={sendEmail}
                        >
                          <div className="flex flex-col gap-6">
                            ...
                            <div>
                              ...
                              <input
                                type="text"
                                name="user_name"
                                className="appearance-none block w-full bg-white dark:bg-gray-700 text-gray-700 dark:text-gray-200 border border-gray-200 dark:border-gray-700 rounded-lg py-3 px-4 leading-tight focus:outline-none focus:border-blue-500"
                                required
                              />
                            </div>
                          ...
                          <div className="mt-6 flex justify-end">
                            <input
                              type="submit"
                              value="Send Message"
                              className="px-6 py-2 text-white bg-gray-100 dark:hover:bg-slate-500 dark:bg-gray-600 rounded focus:outline-none transition-colors"
                            />
                          </div>
                        </form>
                      </div>
        ...
        <div className="border-t border-gray-200 dark:border-gray-800">
          <div className="mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl py-8 lg:py-4 lg:flex lg:items-center lg:justify-between lg:gap-x-3">
            <div className="lg:flex-1 flex items-center justify-center lg:justify-end gap-x-1.5 lg:order-3">
              <a
                href=""
                className="focus:outline-none focus-visible:outline-0 disabled:cursor-not-allowed disabled:opacity-75 aria-disabled:cursor-not-allowed aria-disabled:opacity-75 flex-shrink-0 font-medium rounded-full text-sm gap-x-2 p-2 text-gray-700 dark:text-gray-200 hover:text-gray-900 dark:hover:text-white hover:bg-gray-50 dark:hover:bg-gray-800 focus-visible:ring-inset focus-visible:ring-2 focus-visible:ring-primary-500 dark:focus-visible:ring-primary-400 inline-flex items-center"
              >
      ...
      <div className="fixed bottom-5 right-5">
        {isVisible && (
          <button
            onClick={scrollToTop}
            className="bg-gray-100 bg-opacity-30 backdrop-blur-md backdrop:bg-transparent hover:bg-gray-900 text-white p-3 rounded-full shadow-md transition-all duration-300 flex items-center justify-center text-center  hover:bg-opacity-50"
